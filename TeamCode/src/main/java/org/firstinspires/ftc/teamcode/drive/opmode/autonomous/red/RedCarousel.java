...
public class RedCarousel extends LinearOpMode {
	...
	TrajectoryVelocityConstraint number4 = SampleMecanumDrive.getVelocityConstraint(5, MAX_ANG_VEL, TRACK_WIDTH);
	...
	public void runOpMode() throws InterruptedException {
		...
		TrajectorySequence trajSeqMiddleGoal = drive.trajectorySequenceBuilder(startPose)
				...
				.lineToLinearHeading(new Pose2d(-32, -30, Math.toRadians(-330)))
				...
				.lineToLinearHeading(new Pose2d(-50, -50, Math.toRadians(-340)))
				.UNSTABLE_addTemporalMarkerOffset(0, () -> {
					robot.outtake.lowerBackToIntakePosition();
					//LOWER ARM
				})
				.setConstraints(number, number2)
				.lineToConstantHeading(new Vector2d(-69,-60))
				//spin a duck
				.UNSTABLE_addTemporalMarkerOffset(0, () -> {
				...
				.setConstraints(defaults, number2)
				.waitSeconds(5)
				.lineToLinearHeading(new Pose2d(-57.5, -36, Math.toRadians(-180)))
				/*
		...
		//		.lineToLinearHeading(new Pose2d(-30 , -50, Math.toRadians(-180)))
				...
				.setConstraints(number, number2)
				.lineToConstantHeading(new Vector2d(-69.5,-62))
				//spin a duck
				.UNSTABLE_addTemporalMarkerOffset(0, () -> {
					robot.caroselspinner.supplySpinnersPower(-1);
				})
